...
class AccesOfPageOnVoirdrama extends GatheringUrls
    implements
  ...
  String getRequeteXpathOfLinksInResultsOfSearch() =>
      "//div[@id='ajaxsearchprores7_2']/descendant::div[@class='resdrg']/div/div/h3/a/@href";
  ...
  String getRequeteXpathOfTitleInResultsOfSearch(
    ...
    return "//div[@id='ajaxsearchprores7_2']/descendant::div[@class='resdrg']/div/div/h3/a${attrib}";
  }
  ...
  String getRequeteXpathOfEpisodeOnVideo() =>
      "//div[@class='c-page__content']/div[@class='page-content-listing single-page']/descendant::li/a/@href";
